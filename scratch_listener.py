...
if 'WAYLAND_DISPLAY' in os.environ:
    print("Warning: This script is designed for X11 and might not work correctly under Wayland.", file=sys.stderr)
...
try:
    ...
    print("Ensure you are running this in a graphical session (X11 recommended) and have necessary permissions.", file=sys.stderr)
